<aside class="main-nav-aside">
    ...
    <nav>
        <ul>
            ...
            <li><a href="#"><i class="fa fa-film"></i><span>公開予定</span></a></li>
            <li><a href="/eiga/zaseki/1"><i class="fa fa-map-signs"></i><span>座席予約</span></a></li>
            <li><a href="#"><i class="fa fa-th"></i><span>上映</span></a></li>
            <li><a href="#"><i class="fa fa-home"></i><span>劇場案内</span></a></li>
